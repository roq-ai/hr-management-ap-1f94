  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unleash your team's potential with HR Management Application - Streamlining human resources for better efficiency and productivity."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash your team's potential with HR Management Application - Streamlining human resources for better efficiency and productivity.`}
            </Text>
            <Box
